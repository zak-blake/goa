...
func (c *chatterClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := grpc.Invoke(ctx, "/pb.chatter/Login", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatterClient) Echoer(ctx context.Context, opts ...grpc.CallOption) (Chatter_EchoerClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Chatter_serviceDesc.Streams[0], c.cc, "/pb.chatter/Echoer", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatterClient) Listener(ctx context.Context, opts ...grpc.CallOption) (Chatter_ListenerClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Chatter_serviceDesc.Streams[1], c.cc, "/pb.chatter/Listener", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatterClient) Summary(ctx context.Context, opts ...grpc.CallOption) (Chatter_SummaryClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Chatter_serviceDesc.Streams[2], c.cc, "/pb.chatter/Summary", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatterClient) History(ctx context.Context, in *HistoryRequest, opts ...grpc.CallOption) (Chatter_HistoryClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Chatter_serviceDesc.Streams[3], c.cc, "/pb.chatter/History", opts...)
	if err != nil {
		return nil, err
	}
