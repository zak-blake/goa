...
type Client struct {
	grpccli pb.SecuredServiceClient
...
func NewClient(cc *grpc.ClientConn, opts ...grpc.CallOption) *Client {
	return &Client{
		grpccli: pb.NewSecuredServiceClient(cc),
		opts:    opts,
	}
}

// Signin calls the "Signin" function in pb.SecuredServiceClient interface.
...
// Secure calls the "Secure" function in pb.SecuredServiceClient interface.
...
// DoublySecure calls the "DoublySecure" function in pb.SecuredServiceClient
// interface.
...
// pb.SecuredServiceClient interface.
